...
public class Main {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
				...
				views.View.AffichageTab(monTableau);
				System.out.println("");
				...
				views.View.AffichageTab(monTableauTemp);
				System.out.println("");
				...
				int Valeur = views.View.SaisiInt(saisie);
...
//				int Indice = views.View.SaisiInt(saisie);
				int Indice =views.View.ControleBorneEtInt(saisie, monTableau) ;
						//views.View.SaisiInt(saisie);
